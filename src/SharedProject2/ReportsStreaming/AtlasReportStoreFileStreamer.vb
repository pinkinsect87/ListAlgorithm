...
Public Class AtlasReportStoreFileStreamer
    ...
    Public Function GetStream(FileURI As GptwUri) As IO.Stream Implements IFileStreamer.GetStream
        ...
        Dim RequestUrlTemplate As String = _ReportStoreUrl & "/api/reportstore/retrievefile?token={0}&username={1}&affiliate={2}&uri={3}"
